...
{ id:'military_barony_victory', title:'A Banner Won in Blood',
  ...
  text:'At {cname}, the contingent held to your command while the enemy host broke. Before the surviving banners, {rulername} calls the victory proof no pedigree can gainsay: the settlement of {grantSettlement} and its local works are offered to you. Each season: income {money:grantRevenue}, upkeep {money:grantUpkeep}, dues {money:grantDues}, net {money:grantNet}. You owe {grantTaxShare}% of local tax and {grantLevyShare}% of local troops. The county fort stays with the count.',
  options:[
    { label:'Accept the settlement.', desc:'Become its hereditary baron at no investiture cost. Gain 100 prestige and 20 Standing with the count. The grant is checked again before acceptance.',
      require:{ custom:'military_settlement_available' },
      effects:{ custom:'military_settlement_grant' } },
...
{ id:'military_victory_purse', title:'Victory Honored', trigger:{ never:true }, wartime:true,
  text:'Your victory earns thanks from your patron, but no eligible settlement remains to grant. Your station is unchanged.',
  options:[{ label:'Accept the victory purse.', desc:'Gain {money:100} and 25 prestige.',
    effects:{ gold:100, prestige:25 } },
    { label:'Decline the reward.', effects:{ prestige:15 } }] },
