...
{ id:'commons_uprising_warning', title:'A final petition',
  ...
  text:'The commons of {county} demand {privilege}. You have {warningDays} days to grant it or restore Popular support above {recoverySupport}. Otherwise, county tax and levies fall by 25 to 100%. At -50 support or worse, rebels muster after the warning and fight for independence. Peace costs include 20% of your gold and 10% of your prestige; unjust-war penalties remain.',
  options:[
    { label:'Grant {privilege}. ({money:revoltConcessionGold}; -{revoltPrestige} prestige)',
      desc:'Settle every affected county. Five years of concessions reduce county tax and levy by 25% and give +10 Popular support. Unjust-war penalties remain.',
      effects:{ custom:'commons_uprising_buy_concession' } },
...
{ id:'commons_uprising_local_negotiation', title:'Local Talks in {localCounty}',
  ...
  options:[
    { label:'Negotiate locally. ({money:revoltNegotiationGold}; -{revoltPrestige} prestige)',
      desc:'{revoltNegotiationChance}% chance. Costs are spent even on failure. Success grants five-year concessions; unjust-war penalties remain.',
      effects:{ custom:'commons_uprising_pay_negotiation' }, chance:'revolt_negotiation',
...
{ id:'commons_uprising_begins', title:'The commons rise',
  trigger:{ never:true }, contextValidator:'commons_uprising_valid',
  text:'The commons of {county} resist your refusal of {privilege}. County tax and levies are down {reduction}% for up to {uprisingDays} days. Unrest can spread every {spreadDays} days. Concessions or successful suppression settle all affected counties. Armed rebels continue beyond ordinary disruption deadlines and can win independence by occupying the counties that join them.',
  options:[
    { label:'Grant {privilege}. ({money:revoltConcessionGold}; -{revoltPrestige} prestige)',
      desc:'Settle every affected county. Five years of concessions reduce county tax and levy by 25% and give +10 Popular support. Unjust-war penalties remain.',
      effects:{ custom:'commons_uprising_buy_concession' } },
    { label:'Negotiate a settlement. ({money:revoltNegotiationGold}; -{revoltPrestige} prestige)',
      desc:'{revoltNegotiationChance}% chance to settle all affected counties with five-year concessions. Costs are spent even on failure. Unjust-war penalties remain.',
      effects:{ custom:'commons_uprising_pay_negotiation' }, chance:'revolt_negotiation',
      success:{ text:'The delegates accept the concession and call their neighbors home.',
        effects:{ custom:'commons_uprising_concede' } },
    ...
    { label:'Send the county officers. ({money:revoltSuppressionGold}; -{revoltPrestige} prestige)',
      desc:'{revoltSuppressionChance}% chance to end the uprising. Costs are spent even on failure. Every affected county loses 20 Popular support on success or 30 on failure. Unjust-war penalties remain.',
      effects:{ custom:'commons_uprising_pay_suppression' }, chance:'revolt_suppression',
      success:{ text:'The officers reopen the roads and scatter the gatherings. The commons remember the force used.',
        effects:{ custom:'commons_uprising_suppress' } },
      failure:{ text:'The officers withdraw before the crowds. The failed suppression deepens resentment.',
        effects:{ custom:'commons_uprising_suppression_failed' } } },
