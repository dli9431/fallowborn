...
{ id:'lord_squeezes', title:'A Tally With Your Name On It',
  ...
  options:[
    { label:'Pay without a word. (4 gold)', require:{ goldMin:4 }, desc:'Coin today, and the tally-man moves on.', effects:{ gold:-4 } },
...
{ id:'market_day_find', title:'A Bargain at Market',
  ...
  options:[
    { label:'Buy it. (4 gold)', desc:'Cheap beasts sometimes come with expensive histories.', chance:0.7,
...
{ id:'old_custom_memory', title:'What the Old Folk Remember',
  ...
  options:[
    ...
    { label:'Pay a clerk for a clean copy. (8 gold)', require:{ goldMin:8 }, desc:'Coin turns hearsay into parchment.',
...
{ id:'old_custom_hearing', title:'Before the Lord’s Bench',
  ...
  options:[
    ...
    { label:'Buy a narrow settlement. (10 gold)', require:{ goldMin:10 }, desc:'Purchase peace, and accept a smaller right.',
...
{ id:'old_custom_end', title:'What Is Remembered',
  ...
  options:[
    ...
    { label:'Pay for full confirmation. (12 gold)', require:{ flags:['old_custom_compromise'], goldMin:12, notHoldings:['common_rights'] }, desc:'Coin seals what the bench left half-open.',
    ...
    { label:'Pay the amercement. (8 gold)', require:{ flags:['old_custom_lost'], goldMin:8 }, desc:'Buy your way out of the judgment’s teeth.',
...
{ id:'mill_reckoning', title:'The Miller’s Reckoning', trigger:{ never:true },
  ...
  options:[
    ...
    { label:'Pay both millers and be done. (4 gold)', require:{ flags:['mill_path_carry'] }, desc:'Expensive, but it ends the matter.',
    ...
    { label:'Pay the fine before it grows. (6 gold)', require:{ flags:['mill_path_secret'], goldMin:6 }, desc:'Settle cheaply before the tally swells.',
...
{ id:'masters_empty_bench', title:'The Master’s Empty Bench',
  ...
  options:[
    ...
    { label:'Advance the widow six gold for materials.', require:{ goldMin:6 }, desc:'Charity that may yet return with thanks.',
    ...
    { label:'Buy the tools and obligations together. (12 gold)', require:{ goldMin:12 }, desc:'Take on the bench, debts and all.',
...
{ id:'after_reapers', title:'After the Reapers',
  ...
  options:[
    ...
    { label:'Hire them to thresh. (2 gold)', require:{ goldMin:2 }, desc:'Wages for hunger — labor that may pay double.', chance:'skill_ste', effects:{ gold:-2 },
...
{ id:'retinue_at_door', title:'The Retinue at the Door',
  ...
  options:[
    { label:'Host them properly. (5 gold)', require:{ goldMin:5 }, desc:'A full table buys the captain’s goodwill.', effects:{ gold:-5, opinion:{role:'lord', amt:10}, prestige:3 } },
