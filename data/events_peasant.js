...
{ id:'serf_desperate_measures', title:'Desperate Measures', trigger:{ never:true },
  text:'Your household’s bonds leave little lawful room to climb. Choose what to take from the lord’s land, stores, or dues — and how much danger to accept.',
  options:[
    { label:'Cut and sell forbidden wood.',
      desc:'A quiet trespass with a small return and a light fine if caught.', chance:0.8,
      success:{ text:'The wood is sold before anyone traces it to your door.',
        effects:{ gold:2 } },
      failure:{ text:'The lord’s men catch you cutting and impose a fine.',
        effects:{ gold:-2, opinion:{role:'lord', amt:-4},
          rivalContact:{role:'lord', score:1, cause:'wood_trespass'} } } },
    { label:'Poach protected game.',
      desc:'A better return, but capture puts you directly before the lord.', chance:0.65,
      success:{ text:'Game reaches the pot and the surplus finds a quiet buyer.',
        effects:{ gold:5 } },
      failure:{ text:'The forester catches you over the kill.',
        effects:{ queue:'caught_poaching' } } },
    { label:'Break into the lord’s grain store.',
      desc:'A bold theft with enough grain to sell — if the servants do not corner you.', chance:0.5,
      success:{ text:'You slip the grain away and find a buyer who asks no questions.',
        effects:{ gold:10 } },
      failure:{ text:'The household servants corner you in the store and raise the alarm.',
        effects:{ gold:-4, health:-1, prestige:-4,
          opinion:{role:'lord', amt:-10},
          rivalContact:{role:'lord', score:1, cause:'grain_theft'} } } },
    { label:'Waylay a dues cart.',
      desc:'A violent gamble for a season-changing haul, with a crippling beating if it fails.', chance:0.3,
      success:{ text:'You scatter the escort, hide the coin, and leave no witness willing to name you.',
        effects:{ gold:30 } },
      failure:{ text:'The escort beats you down and reports the attempted robbery.',
        effects:{ gold:-6, health:-5, prestige:-8,
          opinion:{role:'lord', amt:-18},
          rivalContact:{role:'lord', score:2, cause:'dues_robbery'} } } }
  ]},
...
{ id:'lords_notice', title:'The Lord’s Eye', tenureAware:true,
  trigger:{ tierMax:0, roleOpinionAbove:{role:'lord', value:25}, chance:0.001 }, weight:10, once:true,
  text:{ forms:{ select:'value', param:'tenureArchetypeId', cases:{
...
{ id:'flee_serfdom', title:'The Open Road',
  trigger:{ tierMax:0, chance:0.001, roleOpinionBelow:{role:'lord', value:-20} }, weight:6, cooldown:12,
  participants:[
    {slot:'lord', source:'role', role:'lord', required:true, create:true, authorityRole:'lord', sameHome:true},
...
{ id:'old_custom_stakes', title:'Stakes in the Common',
  trigger:{ tierMax:0, minAge:16, chance:0.001 }, weight:15, once:true,
  participants:[
    {slot:'lord', source:'role', role:'lord', required:true, create:true, authorityRole:'lord', sameHome:true},
    {slot:'officer', source:'role', role:'steward', required:true, create:true, authorityRole:'steward', sameHome:true},
    {slot:'witness', source:'local_witness', required:true, createFallback:true, sameHome:true}
