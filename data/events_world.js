...
{ id:'raiders_come', title:'Sails on the Horizon',
  ...
  options:[
    { label:'Flee to the woods with what you can carry.', effects:{ gold:-5, health:0, log:'Survived a raid by hiding.' } },
    { label:'Stand with the levy at the bridge.', require:{ minAge:16 }, chance:0.45,
    ...
    { label:'Hide in the church and pray.', chance:0.5,
...
{ id:'levy_call', title:'The Levy Is Called',
  ...
  options:[
    { label:'March with the levy.', effects:{ setFlag:'on_campaign', profession:'soldier', setFlag2:'was_civilian', log:'Marched to war with the levy.' } },
    { label:'Pay a stranger to march in your place.', require:{ goldMin:10 }, effects:{ gold:-10, prestige:-2 } },
    { label:'Hide until the muster passes.', chance:0.6,
...
{ id:'campaign_ends', title:'The War Lets You Go',
  ...
  options:[
    { label:'Home again.', effects:{ clearFlag:'on_campaign', restoreProfession:true, gold:4, log:'Came home from the war.' } }
  ]},
{ id:'pestilence_arrives', title:'The Pestilence',
  ...
  options:[
    { label:'{god} preserve us.', effects:{ setFlag:'plague_here', piety:3, log:'Pestilence reached {province}.' } }
  ]},
{ id:'pestilence_rages', title:'The Dying Time',
  ...
  options:[
    { label:'Shut your household away.', chance:0.75,
    ...
    { label:'Help bury the dead.', chance:0.55,
    ...
    { label:'Flee to another province.', effects:{ moveRandom:true, gold:-5, clearFlag:'plague_here', log:'Fled the pestilence.' } }
  ]},
{ id:'pestilence_ends', title:'The Bells Fall Silent',
  ...
  options:[ { label:'It is over.', effects:{ clearFlag:'plague_here', piety:5, log:'The pestilence ended.' } } ]},
{ id:'comet', title:'A Hairy Star',
  ...
  options:[
    { label:'An omen of my rise.', effects:{ prestige:5 } },
    { label:'A warning to repent.', effects:{ piety:8 } },
    { label:'A rock in the sky.', effects:{ skills:{lea:1} } }
  ]},
{ id:'wandering_skald', title:'The Storyteller',
  ...
  options:[
    { label:'Buy him ale for the news.', require:{ goldMin:1, religionGroups:['christian','pagan','jewish'] }, effects:{ gold:-1, skills:{dip:1}, worldNews:true } },
    { label:'Buy him supper for the news.', require:{ goldMin:1, religionGroups:['muslim'] }, effects:{ gold:-1, skills:{dip:1}, worldNews:true } },
    { label:'Tell him YOUR story.', chance:0.4,
...
{ id:'conversion_pressure', title:'The New Faith',
  ...
  options:[
    { label:'Take their baptism.', effects:{ convertToProvince:true, piety:0, prestige:5, log:'Converted to the local faith.' } },
    { label:'Keep the old ways.', effects:{ piety:5, prestige:-3 } }
  ]},
{ id:'strange_bounty', title:'The Sea Gives',
  ...
  options:[
    { label:'Take what the sea offers.', chance:0.7,
    ...
    { label:'Report it to the lord.', effects:{ opinion:{role:'lord', amt:8}, gold:2 } },
    { label:'Bury the drowned man properly.', effects:{ piety:8 } }
  ]}
);
