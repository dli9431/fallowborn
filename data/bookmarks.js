...
(function () {
  ...
  var RULERS_867 = {
    ...
    navarra:profile('García Íñiguez','basque',810,8,'patient'),
  ...
  var REALMS_1066 = [
    ...
    realm('navarre_1066','Kingdom of Pamplona','#c04070','pamplona',1,3,
      ruler1066('Sancho IV','basque',1039,9,'patient')),
  ...
  var COMMUNITIES_867 = {
    ...
    ecija:communityList('andalusi','sunni','iberian','catholic'),
    niebla:communityList('andalusi','sunni','iberian','catholic'),
    toledo:communityList('andalusi','sunni','iberian','catholic'),
    granada:communityList('andalusi','sunni','iberian','catholic'),
    malaga:communityList('andalusi','sunni','iberian','catholic'),
    almeria:communityList('andalusi','sunni','iberian','catholic'),
    badajoz:communityList('andalusi','sunni','iberian','catholic'),
    merida:communityList('andalusi','sunni','iberian','catholic'),
    evora:communityList('andalusi','sunni','iberian','catholic'),
    lisboa:communityList('andalusi','sunni','iberian','catholic'),
    santarem:communityList('andalusi','sunni','iberian','catholic'),
    coimbra:communityList('andalusi','sunni','iberian','catholic'),
    silves:communityList('andalusi','sunni','iberian','catholic'),
    beja:communityList('andalusi','sunni','iberian','catholic'),
    valencia:communityList('andalusi','sunni','iberian','catholic'),
    murcia:communityList('andalusi','sunni','iberian','catholic'),
    denia:communityList('andalusi','sunni','iberian','catholic'),
    tortosa:communityList('andalusi','sunni','iberian','catholic'),
    tarragona:communityList('andalusi','sunni','iberian','catholic'),
    lerida:communityList('andalusi','sunni','iberian','catholic'),
    zaragoza:communityList('andalusi','sunni','iberian','catholic'),
    huesca:communityList('andalusi','sunni','iberian','catholic'),
    tudela:communityList('andalusi','sunni','iberian','catholic'),
    pamplona:communityList('basque','catholic','iberian','catholic'),
    alava:communityList('iberian','catholic','basque','catholic'),
    logrono:communityList('iberian','catholic','basque','catholic'),
    aragon:communityList('iberian','catholic','basque','catholic'),
  ...
  var COMMUNITIES_1066 = {
    ...
    niebla:communityList('andalusi','sunni','iberian','catholic'),
    toledo:communityList('andalusi','sunni','iberian','catholic'),
    granada:communityList('andalusi','sunni','berber','sunni','iberian','catholic'),
    malaga:communityList('andalusi','sunni','iberian','catholic'),
    almeria:communityList('andalusi','sunni','iberian','catholic'),
    badajoz:communityList('andalusi','sunni','berber','sunni','iberian','catholic'),
    merida:communityList('andalusi','sunni','iberian','catholic'),
    evora:communityList('andalusi','sunni','iberian','catholic'),
    lisboa:communityList('andalusi','sunni','iberian','catholic'),
    santarem:communityList('andalusi','sunni','iberian','catholic'),
