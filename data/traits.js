...
schemer:    { name:'Schemer', icon:'🕸', 'class':'formation', desc:'Three hidden victories have sharpened a practiced conspirator.', earned:'Complete three hostile schemes.', int:1, inherit:0, noRandom:true, intrigue:{hostileSuccess:0.05} },
