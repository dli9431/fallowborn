...
ambitious:  { name:'Ambitious', icon:'🔥', 'class':'disposition', desc:'Wants more. Always more.', dip:1, mar:1, ste:1, int:1, lea:1, opinion:-5, opposite:'content' },
content:    { name:'Content', icon:'🍵', 'class':'disposition', desc:'At peace with their lot.', int:-1, opinion:5, opposite:'ambitious' },
...
deceitful:  { name:'Deceitful', icon:'🎭', 'class':'disposition', desc:'Truth is a tool like any other.', int:3, dip:-1, opinion:-8, opposite:'honest' },
honest:     { name:'Honest', icon:'⚖', 'class':'disposition', desc:'Their word is iron.', dip:1, int:-2, opinion:8, opposite:'deceitful' },
lustful:    { name:'Lustful', icon:'💋', 'class':'disposition', desc:'Appetites of the flesh.', fert:1.3, opinion:-3, opposite:'chaste' },
chaste:     { name:'Chaste', icon:'🌸', 'class':'disposition', desc:'Restraint of the flesh.', fert:0.7, lea:1, opinion:3, opposite:'lustful' },
...
zealous:    { name:'Zealous', icon:'🕯', 'class':'disposition', desc:'Burning faith.', mar:1, opinion:4, opposite:'cynical' },
cynical:    { name:'Cynical', icon:'🌑', 'class':'disposition', desc:'Believes in little.', int:2, lea:1, opinion:-4, opposite:'zealous' },
...
literate:   { name:'Lettered', icon:'📜', 'class':'formation', desc:'Can read and write — rare gift.', earned:'Learn letters through education or sustained study.', lea:2, ste:1, inherit:0, noRandom:true },
...
roadwise:   { name:'Roadwise', icon:'🧭', 'class':'formation', desc:'Miles have taught which roads to trust.', earned:'Complete three distinct non-targeted journeys.', ste:1, inherit:0, noRandom:true, earn:{threshold:3}, travel:{legDays:-1, roadIncident:-0.15} },
