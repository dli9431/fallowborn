...
FBDATA.items = {
  ...
  knightly_mail: { name:'Knightly Mail Hauberk', icon:'🛡', rarity:'common', value:110,
    ...
    requiresTech:'mail_hauberks', yearMin:867, cultures:['frankish', 'german', 'norman', 'english', 'gaelic', 'brezhon', 'iberian', 'italian', 'lombard', 'occitan', 'basque', 'norse'],
    fx:{ battle:0.05 }, qualityFx:{ battle:0.01 },
  ...
  lamellar_cuirass: { name:'Lamellar Cuirass', icon:'🛡', rarity:'common', value:95,
    ...
    fx:{ battle:0.045 }, qualityFx:{ battle:0.01 },
  ...
  knights_plate: { name:'Knight’s Plate Armor', icon:'🛡', rarity:'common', value:340,
    ...
    fx:{ battle:0.09 }, qualityFx:{ battle:0.01 },
    art:{ kind:'plate', metals:['#939fa6','#b9c3c9'], woods:['#68482b'], grips:['#422e23'] },
    desc:'An articulated steel harness in the western European tradition, worn over padding with mail at the gaps. The helmet is equipped separately.' },
  mail_coif: { name:'Mail Coif', icon:'⛑', rarity:'common', value:55,
    unique:false, slot:'head', ageMin:14, militaryMarket:true,
    requiresTech:'mail_hauberks', yearMin:1100, cultures:['frankish', 'german', 'norman', 'english', 'gaelic', 'brezhon', 'iberian', 'italian', 'lombard', 'occitan', 'basque', 'norse'],
    fx:{ battle:0.02 }, qualityFx:{ battle:0.01 },
  ...
  knightly_lance: { name:'Knightly Lance', icon:'⚔', rarity:'common', value:70,
    ...
    fx:{ battle:0.035 }, qualityFx:{ battle:0.01 },
  ...
  steppe_bow: { name:'Steppe Composite Bow', icon:'🏹', rarity:'common', value:75,
    ...
    fx:{ battle:0.025 }, qualityFx:{ battle:0.01 },
  ...
  crucible_sword: { name:'Crucible-steel Sword', icon:'⚔', rarity:'common', value:125,
    ...
    fx:{ battle:0.03 }, qualityFx:{ battle:0.01 },
  ...
  bearded_axe:     { name:'Bearded Axe', icon:'🪓', rarity:'common', value:22,
    unique:false, slot:'hand', ageMin:12, fx:{ mar:1, battle:0.01 }, qualityFx:{ battle:0.01 },
  ...
  riding_boots:    { name:'Riding Boots', icon:'👢', rarity:'fine', value:40,
    ...
    desc:'Heeled, supple, and plainly made for someone who does not walk to war.' },
