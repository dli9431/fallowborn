...
FBDATA.tenureArchetypes = {
  latin_manorial: {
    ...
    workLabel: 'Work the fields',
    workDescription: 'Farm your family’s plots and work the lord’s fields.',
  ...
  irrigated_fellah: {
    ...
    workLabel: 'Farm and maintain irrigation',
  ...
  norse_coastal_service: {
    ...
    workLabel: 'Work boats and carry goods',
  ...
  woodland_dependence: {
    ...
    workLabel: 'Work the woods and fields',
  ...
  pagan_household_service: {
    ...
    workLabel: 'Work for your master',
  ...
  dependent_farming: {
    ...
    workLabel: 'Work the family farm',
