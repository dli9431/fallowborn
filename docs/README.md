...
1. Set a **focus** in the *Deeds* tab — it is pursued every day until you change it: work your
   ...
   pay, risk, training, and daily mechanics remain the same. Those details appear in the
   focus and events where they matter. **Rank & Realm → Review station & freedom** keeps
   **Station & home** to the household's location, current lord, purchase price, petition,
   and any active freedom offer.
...
a final petition involving up to three directly held counties, listed together. Grant the demanded concession, or take
...
If the warning expires unresolved, each participating county loses 25-100% of tax and levy output for
