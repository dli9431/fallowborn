...
upkeep, wartime household scarcity, the live raised host's base/levy/archer/retinue/
mercenary logistics, and the disclosed fees of current schooling arrangements. The
same components are itemized by `FB.incomeBreakdown`, so the gold sheet, Finance net,
credit capacity, and prudent building automation share one result.
