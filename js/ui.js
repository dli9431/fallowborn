...
(function () {
  ...
  UI.showGreatHolyWarJoin = function () {
    ...
    function showReview() {
      ...
      let h = '<div class="gm-body-text"><p>' + esc(FB.T(
        ...
        'Withdrawing before the promised term is fulfilled costs 200 piety and 100 prestige and records a broken vow. After fulfillment, the ordinary 100 piety and 50 prestige cost applies.')) +
        '</p></div><div class="gm-list">' +
  ...
  UI.showGreatHolyWarWithdraw = function () {
    ...
    const fulfilled = !!(pledge.vowTerms && pledge.vowTerms.mustered &&
      pledge.vowTerms.served >= pledge.vowTerms.seasons);
    const h = '<div class="gm-body-text"><p>' + esc(inherited
      ...
      : fulfilled
        ? FB.T('Your promised term is fulfilled. Withdrawal now costs 100 piety and 50 prestige without recording a broken vow.')
        : FB.T('Your promised term is not fulfilled. Withdrawal costs 200 piety and 100 prestige and records a broken vow.')) +
      '</p></div><div class="gm-list">' +
