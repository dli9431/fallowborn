    ...
    for (const key in (params || {})) {
      ...
      if (value && typeof value === 'object' && value.$item &&
        ...
        const tables = {
          ...
          ailment: FBDATA.ailments, culture: FBDATA.cultures,
          cultureTradition:FBDATA.cultureTraditions, religion:FBDATA.religions,
          ...
          marketGood:FBDATA.marketGoods,
          marketEndowment:FBDATA.marketEndowmentTypes,
