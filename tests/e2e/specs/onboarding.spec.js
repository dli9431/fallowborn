  ...
  async function ({ page }) {
    ...
    const archetypes = [
      ...
      { id:'irrigated_fellah', title:'Irrigated fellah tenure', dutyCount:4,
        ...
        rights:['irrigation_turn'], nearest:'Crop-share delivery', work:'Farm and maintain irrigation' },
      { id:'norse_coastal_service', title:'Coastal household-service tenure', dutyCount:3,
        ...
        nearest:'Seasonal catch share', work:'Work boats and carry goods' },
      { id:'pastoral_steppe', title:'Pastoral dependent tenure', dutyCount:3,
        ...
        nearest:'Pasture due', work:'Tend the herds' },
      { id:'woodland_dependence', title:'Woodland customary tenure', dutyCount:4,
        ...
        nearest:'Woodland mast due', work:'Work the woods and fields' },
