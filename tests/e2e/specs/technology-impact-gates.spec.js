...
test('the prospective review ledger and every gate schema validate together',
  async function ({ page }) {
    ...
    expect(result.featureIds).toEqual([
      ...
      'marriage_discovery',
      'marriage_prospect_culture_persuasion',
    ...
    expect(establishedModes).toEqual([
      'none', 'none', 'none', 'none', 'none', 'none', 'hard', 'none', 'hard',
      'hard', 'hard', 'hard', 'hard', 'soft', 'hard', 'soft', 'hard', 'none',
      'none', 'hard', 'none', 'hard', 'hard', 'none', 'soft', 'none', 'soft',
      'none', 'none', 'none', 'none', 'hard', 'none', 'none', 'none', 'none',
      'none', 'none', 'hard', 'hard', 'hard', 'hard', 'hard', 'hard', 'hard',
      'hard', 'hard', 'hard', 'hard', 'hard', 'none', 'none', 'soft', 'none',
      'hard', 'hard', 'hard', 'none', 'none', 'hard', 'hard', 'hard', 'none',
      'hard', 'none', 'none', 'none', 'none', 'none', 'soft', 'none', 'none',
      'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'soft',
      'soft', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none',
      'none', 'none', 'soft', 'hard', 'none', 'hard', 'none', 'none', 'none',
      'none', 'none', 'soft', 'soft', 'none', 'none', 'none', 'none', 'none',
      'soft', 'none', 'hard', 'none', 'none', 'hard', 'hard', 'none', 'none',
      'none', 'none', 'none'
    ]);
